...
function Login() {
  ...
  const onSubmit = async (data) => {
    ...
    await axios
      .post("https://the-book-nook-baackend.onrender.com/user/login", userInfo)
      .then((res) => {
...
function Login() {
  ...
  <div className="modal-box">
    ...
    <div className='mt-4 space-y-2'>
        <span>Password</span>
        <br />
        <input type="password" placeholder='Enter your password' className='w-50 px-3 py-1 border rounded-md outline-none' {...register("password", {required: true})}/>
        <br />
